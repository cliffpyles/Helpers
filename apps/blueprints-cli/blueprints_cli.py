    ...
    for template in templates:
        ...
        if target_path.exists() and not force:
            if not dry:
                ...
                click.echo(f"Skips: File '{target_path}' already exists. Use --force to overwrite.")
...
def generate_command(blueprint_name, blueprint_instance_name, variables_str, output, force, dry):
    ...
    generate_files_from_blueprint(blueprint_path, blueprint_instance_name, variables_str, output, force, dry)
...
@click.option("--dry", is_flag=True, default=False, help="Perform a dry run without generating files.")
def generate(blueprint_name, blueprint_instance_name, var, output, force, dry):
    generate_command(blueprint_name, blueprint_instance_name, var, output, force, dry)
