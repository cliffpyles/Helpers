...
ln -s "$SCRIPT_DIR/blueprints_cli.py" "$HOME_DIR/bin/blueprints"
ln -s "$SCRIPT_DIR/blueprints_cli.py" "$HOME_DIR/bin/bp"
...
echo "Type 'blueprints' or 'bp' to use the blueprints-cli app."
